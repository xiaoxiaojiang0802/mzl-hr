package com.pms.common.actable.mapper;

import com.baomidou.mybatisplus.annotation.InterceptorIgnore;
import com.pms.common.actable.command.SysMysqlColumns;
import com.pms.common.actable.command.SysMysqlTable;
import com.pms.common.actable.command.TableConfig;
...
public interface CreateMysqlTablesMapper {
     ...
     * @return int
     */
    Integer selectCountKey(@Param("tableName") String tableName);
