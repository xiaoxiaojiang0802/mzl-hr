...
import com.pms.common.core.domain.dto.RoleDTO;
import com.pms.common.core.domain.entity.SysUser;
import com.pms.common.core.domain.model.LoginUser;
import com.pms.common.core.domain.model.XcxLoginUser;
import com.pms.common.core.service.LogininforService;
import com.pms.common.enums.DeviceType;
import com.pms.common.enums.LoginType;
import com.pms.common.enums.UserStatus;
import com.pms.common.exception.user.CaptchaException;
import com.pms.common.exception.user.CaptchaExpireException;
import com.pms.common.exception.user.UserException;
import com.pms.common.helper.LoginHelper;
import com.pms.common.utils.DateUtils;
import com.pms.common.utils.MessageUtils;
import com.pms.common.utils.ServletUtils;
...
public class SysLoginService {
    ...
    private boolean validateSmsCode(String phonenumber, String smsCode, HttpServletRequest request) {
        String code = CacheUtils.get(CacheConstants.CAPTCHA_CODE_KEY + phonenumber);
    ...
    private void checkLogin(LoginType loginType, String username, Supplier<Boolean> supplier) {
        ...
        Integer errorNumber = CacheUtils.get(errorKey);
        // 锁定时间内登录 则踢出
        ...
        if (supplier.get()) {
            ...
            if (errorNumber.equals(maxRetryCount)) {
                CacheUtils.put(errorKey, errorNumber);
                asyncService.recordLogininfor(username, loginFail, MessageUtils.message(loginType.getRetryLimitExceed(), maxRetryCount, lockTime), request);
                throw new UserException(loginType.getRetryLimitExceed(), maxRetryCount, lockTime);
            } else {
                // 未达到规定错误次数 则递增
