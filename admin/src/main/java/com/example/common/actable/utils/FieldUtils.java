package com.example.common.actable.utils;
...
public class FieldUtils {
    ...
    public static <T> void buildFieldValue(Object fieldValue, T newInstance, Field field) {
        try {
            String fieldValueStr = com.example.common.actable.utils.CommonUtil.toString(fieldValue);
            ...
            switch (typeName) {
                ...
                case "class java.lang.String":
                    field.set(newInstance, com.example.common.actable.utils.CommonUtil.getStringDef(fieldValueStr));
                    break;
                case "class java.lang.Long":
                    field.set(newInstance, com.example.common.actable.utils.CommonUtil.getLong(fieldValueStr));
                    break;
                ...
                case "class java.lang.Double":
                    field.set(newInstance, com.example.common.actable.utils.CommonUtil.getDouble(fieldValueStr));
                    break;
